...
static Contact* createContactNode(Contact contact) {
...
static void insertSorted(Contact* new_contact) {
    if (!head) {
...
static void removeFromList(Contact* contact) {
    if (contact->prev) {
...
static void reinsertContact(Contact* contact) {
